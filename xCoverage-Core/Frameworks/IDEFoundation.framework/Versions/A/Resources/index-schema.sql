...
--
CREATE TABLE file (id INTEGER PRIMARY KEY AUTOINCREMENT, lowercaseFilename INTEGER NOT NULL, filename INTEGER NOT NULL, directory INTEGER NOT NULL, moduleurl INTEGER NOT NULL, inProject INTEGER NOT NULL);
